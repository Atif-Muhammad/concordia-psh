...
export class DepartmentController {
    ...
    @Patch("update")
    async updateDepartment(@Query() depID: {depID: string}, @Body() payload: Partial<DepartmentDto>){
        return await this.departmentService.updateDepartment(Number(depID.depID), payload);
    }
    @Delete("remove")
