...
export class AcademicsController {
  ...
  async updateTsm(
    ...
    return await this.academicService.updateTsm(Number(tsmID.tsmID), payload);
  }
  @Delete('tsm/remove')
  ...
  async updateTcm(
    ...
    return await this.academicService.updateTcsm(Number(tcmID.tcmID), payload);
  }
  @Delete('tcm/remove')
  ...
  async removeTimetable(@Query() timetableId: { timetableId: string }) {
    return await this.academicService.removeTimetable(
      Number(timetableId.timetableId),
    );
  }
}
